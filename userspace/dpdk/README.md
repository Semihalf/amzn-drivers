...
ENA PMD v2.3.0 from DPDK v21.05 was backported to the all LTS DPDK versions,
...
targeted for the new LTS release v19.11.9, the v19.11.8 will be no longer
supported).
...
```sh
# Use the patches from the 'backports/v20.11.1' directory and apply them to the
# repository, which can be found under the 'dpdk_src' location
./backports/apply-patches.sh -p backports/v20.11.1 -d dpdk_src
```
